function ControlParadigm = make_ctrl_prdgms_029(odor_rat,bckg,inittime,width,duration,save_name,saveit)
%  ControlParadigm = make_ctrl_prdgms_029(odor_rat,total_flow,inittime,width,duration,save_name,saveit)
