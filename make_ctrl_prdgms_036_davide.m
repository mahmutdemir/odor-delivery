function ControlParadigm = make_ctrl_prdgms_036_davide(main,odor_vol,mix_vol,bckg_vol,inittime,width,lag,interval,duration,nofpulses,save_name,saveit)
%  ControlParadigm = make_ctrl_prdgms_036_davide(main,odor_vol,mix_vol,bckg_vol,inittime,width,lag,interval,duration,nofpulses,save_name,saveit)
% function ControlParadigm = make_ctrl_prdgms_036_davide(main,odor_vol,mix_vol,bckg_vol,inittime,width,lag,interval,duration,nofpulses,save_name,saveit)
...
%   duration:   sec, will only be used if nofpulses is 1
...
sr = 10000;  % digitization sampling rate Hz 
    ...
    voltages(1,:) = main/1000;  % write voltage for the main air MFC
