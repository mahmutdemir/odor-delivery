function ControlParadigm = make_ctrl_prdgms_045_WA_pulses(ovol,cvol,pulsevol,initonoff,inittime,width,interval,n_of_pulses,T,save_name,saveit,mfc_vol,mfc_valve,main_air)
%  ControlParadigm = make_ctrl_prdgms_045_WA_pulses(ovol,cvol,pulsevol,initonoff,inittime,width,interval,n_of_pulses,T,save_name,saveit,mfc_vol,mfc_valve,main_air)
% function ControlParadigm = make_ctrl_prdgms_045_WA_pulses(ovol,cvol,pulsevol,initonoff,inittime,width,interval,n_of_pulses,T,save_name,saveit,mfc_vol,mfc_valve,main_air)
