function ControlParadigm = make_ctrl_prdgms_024(maxfreq,maxtime,corr_length,gate_corr,inittime,width,duration,save_name,saveit)
%  ControlParadigm = make_ctrl_prdgms_024(maxfreq,maxtime,corr_length,gate_corr,inittime,width,duration,save_name,saveit)
% function ControlParadigm = make_ctrl_prdgms_024(maxfreq,maxtime,corr_length,gate_corr,inittime,width,duration,save_name,saveit)
...
% apply negative voltages less than -0.1 volt
...
max_rate = 30;  % the max flow rate to be 300 ml/min
    ...
    mix_rate = -odor_rate;
    odor_rate(odor_rate<0) = -.1;
    mix_rate(mix_rate<0) = -.1;
