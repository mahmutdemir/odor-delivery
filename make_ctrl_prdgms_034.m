function ControlParadigm = make_ctrl_prdgms_034(odor_rat,bckg,inittime,lag,width,interval,nofpulses,save_name,saveit)
%  ControlParadigm = make_ctrl_prdgms_034(odor_rat,bckg,inittime,lag,width,interval,nofpulses,save_name,saveit)
% function ControlParadigm = make_ctrl_prdgms_034(odor_rat,bckg,inittime,lag,width,interval,nofpulses,save_name,saveit)
