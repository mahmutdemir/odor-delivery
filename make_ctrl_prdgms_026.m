function ControlParadigm = make_ctrl_prdgms_026(odor_rat,total,inittime,width,duration,save_name,saveit)
%  ControlParadigm = make_ctrl_prdgms_026(odor_rat,total_flow,inittime,width,duration,save_name,saveit)
% function ControlParadigm = make_ctrl_prdgms_026(odor_rat,total_flow,inittime,width,duration,save_name,saveit)
